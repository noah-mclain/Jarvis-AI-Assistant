#!/usr/bin/env python3
"""
Verify GPU availability and specifications for text model training.
"""

import sys
import torch

def verify_gpu_for_text_model():
    """
    Verify that a suitable GPU is available for text model training.
    """
