...
def patch_attention_mask_converter():
    ...
    try:
        ...
        try:
            result = converter._unmask_unattended(test_mask)
...
def main():
    ...
    if success1 and success2:
        print("\n✅ Successfully patched both functions!")
        print("The 'got multiple values for argument unmasked_value' error should be fixed.")
    elif success1:
        print("\n⚠️ Partially successful: Fixed AttentionMaskConverter._unmask_unattended")
        print("The error might still occur in _prepare_4d_causal_attention_mask_for_sdpa")
    elif success2:
        print("\n⚠️ Partially successful: Fixed _prepare_4d_causal_attention_mask_for_sdpa")
        print("The error might still occur in AttentionMaskConverter._unmask_unattended")
    else:
        print("\n❌ Failed to patch both functions")
