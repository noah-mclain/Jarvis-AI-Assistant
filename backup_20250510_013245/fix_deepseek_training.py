...
Usage:
    python fix_deepseek_training.py [--path /path/to/unified_deepseek_training.py]
"""
...
def main():
    ...
    parser.add_argument("--path", type=str, default="/notebooks/unified_deepseek_training.py",
